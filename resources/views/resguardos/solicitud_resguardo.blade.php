                    ...
                    <div class="card card-body">
                        <form action="{{ route('resguardoEmpleadoRegistro') }}"
                            ...
                            <div class="form-group row">
                                <label for="activoId" class="col-md-2 col-form-label text-md-right">{{ __('Seleccione Activos') }}</label>
                                <select multiple class="form-control col-md-8" id="activoId" name="activoId"
                            ...
                            <div class="form-group row">
                                ...
                                <label for="activoId" class="col-md-2 col-form-label text-md-right">{{ __('Seleccione accesorios(si es necesario)') }}</label>
                                <select multiple class="form-control col-md-8" id="activoId" name="activoId"
