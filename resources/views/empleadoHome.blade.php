                ...
                <div class="jumbotron text-center jumbo-3">
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu">
                            ...
                            <a class="dropdown-item" href="{{ route('preresguardosAllEmpleado') }}">Ver mis solicitudes pendientes</a>
                            <a class="dropdown-item" href="{{route('allResguardosIndividual')}}">Ver mis solicitudes aprobadas</a>
                        </div>
                    </div>
                </div>
            </div>
